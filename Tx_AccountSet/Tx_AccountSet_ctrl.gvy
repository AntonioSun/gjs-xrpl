...
start {
  def load_testname = 'Tx_AccountSet'
  ...
  plan {
    ...
    csv name: 'CSV Tx_AccountSet', file: 'Tx_AccountSet.csv', variables: ["s_account","s_secret"]
    ...
    insert 'Tx_AccountSet_ins.gvy', variables: [
      "vf_name": 'TGroup-Tx_AccountSet', "vf_enabled": true, "vf_delay": '${c_lt_delay}',
