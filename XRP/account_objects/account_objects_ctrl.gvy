...
start {
  def load_testname = 'account_objects'
  ...
  plan {
    variables {
      ...
      variable(name: 'c_cfg_TestName', value: 'account_objects', description: 'Test name to identify different tests')
    ...
    csv name: 'CSV account_objects', file: 'account_objects.csv', variables: ["s_account","s_secret"], recycle: false, stopUser: true
   ...
   check_response applyTo: 'children', {
    ...
    group(name: 'TGroup', delay: '${c_lt_delay}', delayedStart: true,
      ...
      insert 'account_objects_ins.gvy'
    }
